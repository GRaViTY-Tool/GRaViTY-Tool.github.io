...
- Sven Peldszus, Jens Bürger, Jan Jürjens: UMLsecRT: Reactive Security Monitoring of Java Applications With Round-Trip Engineering; Transactions on Software Engineering (TSE); 2024 - [paper](https://doi.ieeecomputersociety.org/10.1109/TSE.2023.3326366)
- Katja Tuma, Sven Peldszus, Daniel Strüber, Riccardo Scandariato, Jan Jürjens: Checking Security Compliance between Models and Code; Software and Systems Modeling (SoSyM), vol. 22, pp. 273-296, 2022 - [paper- open access](https://doi.org/10.1007/s10270-022-00991-5)
- Secure Data-Flow Compliance Checks between Models and Code Based on Automated Mappings; In: Proceedings of the International Conference on Model Driven Engineering Languages and Systems (MODELS), pp. 23-33, 2019 - [paper](https://doi.org/10.1109/MODELS.2019.00-18)
...
- Sven Peldszus, Géza Kulcsár, Malte Lochau, Sandro Schulze: Incremental Co-Evolution of Java Programs based on Bidirectional Graph Transformation. In: Proceedings of the Principles and Practices of Programming on The Java Platform (PPPJ), pp. 138-151, 2015 - [paper](http://dx.doi.org/10.1145/2807426.2807438)
...
### License
This project is licensed under the Eclipse Public License - see the [LICENSE](https://github.com/GRaViTY-Tool/gravity-tool/blob/master/LICENSE) file for details.

## Contact
[Sven Peldszus](peldszus.com) (sven.peldszus@gu.se)  
